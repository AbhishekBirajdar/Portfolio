    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-[#0000000] text-[18px] font-bold cursor-pointer flex '>
             &nbsp;
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((nav) => (
            <li
              key={nav.id}
              className={`${
                active === nav.title ? "text-[#0000000]" : "text-white"
              } hover:text-[#0000000] text-[18px] font-bold cursor-pointer flex`}
              ...
              {navLinks.map((nav) => (
                <li
                  ...
                  className={`font-poppins font-bold cursor-pointer text-[16px] ${
                    active === nav.title ? "text-[#0000000]" : "text-secondary"
                  }`}
                  onClick={() => {
                    setToggle(!toggle);
                    setActive(nav.title);
